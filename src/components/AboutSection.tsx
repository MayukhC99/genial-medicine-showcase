...
function AnimatedAchievementCard({ 
  ...
  const isPercentage = label === "Quality Compliance";
      ...
      <CardContent className="p-6 text-center">
        <div className="mb-4 flex justify-center">
          <div className="p-3 rounded-full bg-gradient-primary/10 group-hover:bg-gradient-primary/20 transition-colors duration-300">
            <Icon className={`h-8 w-8 ${color} group-hover:animate-pulse`} />
          </div>
        </div>
        <div className={`text-3xl font-bold mb-2 ${color} group-hover:scale-110 transition-transform duration-300`}>
          {isPercentage ? `${count.toFixed(1)}%` : `${count}+`}
        </div>
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20">
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-8">
              Genial Healthcare Pvt. Ltd. has been serving the healthcare and nutrition space for over {yearsOfExcellence} years, driven by a clear vision: to deliver reliable, high-quality medicines and nutrition solutions while creating lasting value for customers and employees alike.
            </p>
        ...
        <div className="text-center bg-gradient-hero rounded-3xl p-12 shadow-medical animate-fade-in-up">
          ...
          <p className="text-xl text-muted-foreground leading-relaxed max-w-4xl mx-auto">
            "To develop, manufacture, and deliver innovative pharmaceutical solutions that enhance health care, improve quality of life, and contribute to the advancement of global healthcare through excellence, integrity, and compassion."
          </p>
        </div>
      </div>
    </section>
